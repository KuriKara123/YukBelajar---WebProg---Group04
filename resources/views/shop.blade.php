...
@section('content')
  <style>
    ...
    .brand-list li .chkbrand, .category-list li .chk-category{
      width: 1rem;
      height: 1rem;
      color: #e4e4e4;
      border: 0.125rem;
                ...
                <ul class="list list-inline mb-0">
                  ...
                  <li class="list-item">
                    <sapn class="menu-link py-1">
                      <input type="checkbox" class="chk-category" name="categories" value="{{$category->id}}" @if(in_array($category->id, explode(',',$categories))) checked="checked" @endif />
                      {{$category->name}}
                    </sapn>
          ...
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="price_range" value="" data-slider-min="1"
                data-slider-max="500000" data-slider-step="1000" data-slider-value="[{{$min_price}},{{$max_price}}]" data-currency="Rp." />
              <div class="price-range__info d-flex align-items-center mt-2">
                ...
                <div>
                  ...
                  <span class="price-range__max">Rp.500000</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="shop-list flex-grow-1">
                ...
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      ...
                      Promo <br /><strong>BACK2SCHOOL</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Dapatkan promo menarik dari kami untuk menyambut anda masuk ke dalam kegiatan
                      sekolah lagi.
                    </h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #06a4b7;">
                    <img loading="lazy" src="assets/images/shop/shopbanner1.jpg" width="630" height="450"
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      INFO<br /><strong>RELEASING YUKBELAJAR</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Nikmati segala pelajaran gratis tanpa bayar selama periode peluncuran web kami. Yuk tunggu apa lagi?</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/shopbanner2.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
              ...
              <div class="slide-split h-100 d-block d-md-flex overflow-hidden">
                <div class="slide-split_text position-relative d-flex align-items-center"
                  ...
                  <div class="slideshow-text container p-3 p-xl-5">
                    <h2
                      class="text-uppercase section-title fw-normal mb-3 animate animate_fade animate_btt animate_delay-2">
                      NEWS <br /><strong>MANDARIN RELEASE</strong></h2>
                    <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Ada Pelajaran baru menarik lho. Mau tau apa pelajarannya? Yuk disimak!</h6>
                  </div>
                </div>
                <div class="slide-split_media position-relative">
                  <div class="slideshow-bg" style="background-color: #f5e6e0;">
                    <img loading="lazy" src="assets/images/shop/shopbanner3.jpg" width="630" height="450"
                      alt="Women's accessories" class="slideshow-bg__img object-fit-cover" />
                  </div>
                </div>
              </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          <div class="breadcrumb mb-0 d-none d-md-block flex-grow-1">
            ...
            <a href="#" class="menu-link menu-link_us-s text-uppercase fw-medium">The Course</a>
          </div>
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                <div class="product-card__review d-flex align-items-center">
                  ...
                  <span class="reviews-note text-lowercase text-secondary ms-1">4.9</span>
                </div>
